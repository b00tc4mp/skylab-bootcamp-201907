...
const retrieveClosedOrders = require('.')
...
describe('logic - retreieve closed orders', () => {
    ...
    it('should succeed on correct data', async () => {
        ...
        const orders = await retrieveClosedOrders(userId)

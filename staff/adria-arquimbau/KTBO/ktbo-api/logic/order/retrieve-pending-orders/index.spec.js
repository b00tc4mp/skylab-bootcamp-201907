...
const retrievePendingOrders = require('.')
...
describe('logic - retreieve pending orders', () => {
    ...
    it('should succeed on correct data', async () => {
        ...
        const orders = await retrievePendingOrders(userId)

...
const { HOME, SEARCH, SIGN_IN, SIGN_UP, SIGN_OUT, DETAIL, TOGGLE_FAV, SELECT_LANG, FAVORITE } = require('./paths')
...
app.get(FAVORITE, (req, res) => {
    const { session: { userId, token, lang, query } } = req
...
app.post(TOGGLE_FAV, formBodyParser, (req, res) => {
    const { body: { id: duckId }, session: { userId, token, view } } = req

...
const { signInPath, signUpPath, signOutPath, favPath } = require('./config')
const LangSelector = require('../lang-selector')

function Header(name, query, lang) {
    const { hello, signUp, signIn, signOut, fav } = literals[lang]
    ...
    return `<header class="header">
        ...
        ${name && `<nav>
                <ul>
                    ...
                    <li><a method="get" href="${favPath}">${fav}</a></li>
                </ul>

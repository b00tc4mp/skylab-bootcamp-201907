...
function aciertosFallos(){
    if(preguntas.every(item => item.status === 1 )){
            ...
            document.getElementById("pregunta").innerHTML = 'Has ganado';
        }
    else{
       document.getElementById("pregunta").innerHTML = `Has acertado ${acertadas}, y has fallado ${falladas} que lástima.`
    }
}

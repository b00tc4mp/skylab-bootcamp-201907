...
function Day({ history, match }) {
        ...
        return dayTasks.map(task => {
            ...
            if (start <= hour && hour < end) {
                ...
                <div className="timetable__task-intro">
                   ...
                   <i className="fas fa-minus-circle" onClick={() => handleDeleteTask(task._id)}></i>
                </div>
    ...
    return <div className="day">
        ...
        <div className="day__toolbar">
            ...
            <form>
                <input className="day__search-input" type="text" placeholder="Search [in progress]" /> <i className="fa fa-search"></i>
            </form>
        </div>

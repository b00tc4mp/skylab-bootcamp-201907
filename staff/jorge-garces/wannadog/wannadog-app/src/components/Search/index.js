...
export default function ({ onSearch }) {
    ...
    return <>
        ...
        <form onSubmit={event => {
            ...
            onSearch(distance, breed, gender, size, age, neutered, withDogs, withCats, withChildren)
        }}>

            <label for="distance">Distance</label>
            <select name="distance">
                <option value="0"> I don't mind</option>
                <option value="1"> Up to 10km</option>
                <option value="1"> Up to 50km</option>
                <option value="1"> Up to 100km</option>
                <option value="1"> Up to 200km</option>
                <option value="1"> Up to 500km</option>
            </select>
            ...
            <label for="neutered">Nuetered</label>
            <select name="neutered">
                <option value="false"> I don't mind</option>
                <option value="true"> Yes</option>
            </select>

            <label for="withDogs">Good with dogs</label>
            <select name="withDogs">
                <option value="true"> Yes</option>
                <option value="false"> No / Not tested</option>
            </select>

            <label for="withCats">Good with cats</label>
            <select name="withCats">
                <option value="true"> Yes</option>
                <option value="false"> No / Not tested</option>
            </select>

            <label for="withChildren">Good with children</label>

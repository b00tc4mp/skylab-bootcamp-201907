...
class Landing extends Component {
  ...
  render() {
    return (
      <>
        {this.state.visible === 'landing' && (
          <InitialButton handleVisible={this.handleVisible} />
        )}

        {this.state.visible === 'logged' && (
          <LoggedButton handleVisible={this.handleVisible} />
        )}

        {this.state.visible === 'logged' && (
          <Register
            onRegister={this.handleRegister}
            onBack={() => this.setState({ visible: 'landing', ducks: [] })}
          />
        )}
        ...
        {this.state.visible === 'login' && (
          <Login
            ...
            onBack={() => this.setState({ visible: 'landing' })}
          />
        )}
        {this.state.visible === 'landing' && (
        ...
        {!this.state.duck
          ...
          : this.state.visible === 'landing' && (
              <DuckDetail
                ...
                onBack={() => this.setState({ duck: undefined })}
              />
            )}
      </>
    )

...
router.post ('/users/:id/properties/:propertyId/owners/', [tokenMiddleware, jsonBodyParser], registerPropertyOwner) //l'endpoint no pot mostrar info de una cosa no registrada

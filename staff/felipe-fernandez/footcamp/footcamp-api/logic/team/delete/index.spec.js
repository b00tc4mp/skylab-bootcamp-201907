...
describe('logic - delete team', () => {
    ...
    it('should succeed on correct data', async () => {
        ...
        it('should fail on undefined league teamId', () => 
            expect(() => 
                logic.deleteTeam(id, leagueId, undefined)
         ).to.throw(`team Id with value undefined is not a string`)
        )

        it('should fail on undefined user id', () => 
            expect(() => 
                logic.deleteTeam(undefined, leagueId, teamId)
        ).to.throw(`id with value undefined is not a string`)
        )

        it('should fail on undefined leagueId', () => 
            expect(() => 
                logic.deleteTeam(id, undefined, teamId)
        ...
        it('should fail on non-string leagueId', () => 
         ...
         it('should fail on empty id', () => 
            expect(() => 
                    logic.deleteTeam('', leagueId, teamId)
            ).to.throw(`id is empty or blank`)
            )

        it('should fail on empty leagueId', () => 
            expect(() => 
                    logic.deleteTeam(id, '', teamId )
        ).to.throw(`league Id is empty or blank`)
            )

        it('should fail on empty name teamId', () => 
             expect(() => 

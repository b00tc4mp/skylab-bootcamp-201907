...
describe('logic - retrieve all league teams ', () => {
    ...
    it('should succeed on correct data', async () => {
        ...
        const result = await logic.retrieveTable(id, leagueId)
    ...
    it('should fail if the league does not exist', async () => {
        ...
        await League.deleteMany()
        try {
             await logic.retrieveTable(id, leagueId)
        } catch(error) {
    ...
    it('should fail on undefined user id', () => 
        expect(() => 
            logic.retrieveTable(undefined, leagueId)
    ).to.throw(`id with value undefined is not a string`)
    )

    it('should fail on undefined leagueId', () => 
        expect(() => 
            logic.retrieveTable(id, undefined)
   ...
   it('should fail on non-string user id', () => 
    ...
    it('should fail on non-string leagueId', () => 
     ...
     it('should fail on empty id', () => 
        expect(() => 
                logic.retrieveTable('', leagueId)
        ).to.throw(`id is empty or blank`)
        )

    it('should fail on empty leagueId', () => 
        expect(() => 
                logic.retrieveTable(id, '')

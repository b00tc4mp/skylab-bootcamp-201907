...
function Header(name, query, lang, ducks, duck, res) {
    ...
    res.render('home', { name, hello, signUp, signIn, signOut, favorite, signInPath, signUpPath, signOutPath, selectLangPath, search, searchPath, duck, ducks, favoritePath,  goBackToResults, query })
}

...
describe('logic - list all pending of a city', () => {
 ...
 it('should fail on empty userId', () =>
    expect(() =>
        logic.listPending('', '5d70f41b7d4edc12334851db', 'pending')
    ).to.throw('userId is empty or blank')
)

it('should fail on undefined userId', () =>
    expect(() =>
        logic.listPending(undefined, '5d70f41b7d4edc12334851db', 'pending')
    ).to.throw(`userId with value undefined is not a string`)
)

it('should fail on wrong data type', () =>
    expect(() =>
        logic.listPending(123, '5d70f41b7d4edc12334851db', 'pending')

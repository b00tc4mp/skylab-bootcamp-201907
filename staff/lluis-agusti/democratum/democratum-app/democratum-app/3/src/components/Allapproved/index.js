...
export default withRouter(function ({ history, onLogout }) {
    ...
    const { selectedPoll, setSelectedPoll } = useContext(Context)
    ...
    const [ polls, setPolls ] = useState(null)
     ...
     useEffect(() => {
        (async () => {
            ...
            const res = await logic.listApproved('5d70f41b7d4edc12334851db')
    ...
    <h2 className="pollcategoryname"><b>Approved</b></h2>
    {polls && <ul>

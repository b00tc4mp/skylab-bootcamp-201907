...
// /**
//  * Detail Duck Abstraction
//  * 
//  * @param {HTMLElement} container 
//  */

// function ResultsDuck(container) {
//     Component.call(this, container);
// }

// ResultsDuck.prototype = Object.create(Component.prototype);
// ResultsDuck.prototype.constructor = ResultsDuck;

// ResultsDuck.prototype.listItems = function (details) {
//     var ul = this.container.getElementsByTagName('ul')[0];
//     ul.innerHTML = '';
...
//         this.displayDetail(li, detail); 
//     }.bind(this)); // WATCH this
// };

// ResultsDuck.prototype.displayDetail = function(li, detail) {
//     li.innerText = detail;
// };

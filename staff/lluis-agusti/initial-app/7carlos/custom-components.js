...
DuckDetail.prototype.displayDuck = function (duck) {
    ...
    a.innerText = "Link: " + duck.link;
    this.container.appendChild(a);

    // Manu lo ha hecho seleccionando el target uno a uno (getElementsByTagName) en vez de autocreado como los results.

...
describe('logic', () => {
    ...
    describe('retrieve user', () => {
        ...
        beforeEach(() => {
         ...
         it('should succeed retrieve user on matching criteria', () => {
            const _user = logic.retrieveUser(user.email)
            expect(_user).toEqual(user)
        })

        it('should fail on empty email provided', () => {
            expect(() => {
                logic.retrieveUser()
            }).toThrowError(Error, 'E-mail is empty or blank.')
        })
        ...
        it('should fail on non-valid e-mail', () => {
            expect(() => {
                logic.retrieveUser('aaaa')
            }).toThrowError(Error, 'E-mail is invalid.')
        })


        it('should fail when e-mail not found in database', () => {
            expect(() => {
                logic.retrieveUser('a@a.com')
            }).toThrowError(Error, 'E-mail not found.')
        })
    })

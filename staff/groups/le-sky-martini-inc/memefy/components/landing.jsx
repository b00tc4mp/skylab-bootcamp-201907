...
class Landing extends Component {
    constructor() {
        ...
        this.handleToggleFavDuckDetail = this.handleToggleFavDuckDetail.bind(this)
    }
    ...
    handleToggleFavDuckDetail(id) {
        const { props: { user, onLogin }, handleRetrieveDuck } = this

        user ? logic.toggleFavDuck(user, id, handleRetrieveDuck) : onLogin()
    }

    render() {
        const { state: { ducks, duck }, handleSearch, handleRetrieveDuck, handleRegister, handleBackFromDetail, handleLogin, handleLogout, handleToggleFavDuck, handleToggleFavDuckDetail, props: { user } } = this
        ...
        return <>
            ...
            {!duck ?
                ...
                :
                <DuckDetail duck={duck} onBack={handleBackFromDetail} onToggle={handleToggleFavDuckDetail} />}
        </>
    }
}
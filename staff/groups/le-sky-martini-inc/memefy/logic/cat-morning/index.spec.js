{
    ...
    describe('logic - search gifs', () => {
        ...
        it('should succeed on matching criteria', () => {
            ...
            return logic.searchMorning(undefined, undefined, query)
                .then(gifs => {
        ...
        it('should fail on undefined query', () =>
            expect(() => logic.searchMorning()).toThrowError(TypeError, `query with value undefined is not a string`)
        )
        ...
        describe('when user already has favorite gifs', () => {
            ...
            it('should succeed on matching criteria', () => {
                ...
                return logic.searchMorning(credentials.id, credentials.token, query)
                    .then(gifs => {
                        expect(gifs).toBeDefined()
                        expect(gifs instanceof Array).toBeTruthy()
                        expect(gifs.length).toBe(25)

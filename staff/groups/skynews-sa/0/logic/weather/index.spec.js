{
  describe('logic - search weather', () => {
    ...
    it('should succes humidity', () => {
      ...
      return logic.weather("41.390205", "2.154007")
        .then(result => {expect(result.currently.humidity).toBeDefined()
        })
    })
    ...
    it('should wrong humidity', () => {
      ...
      return logic.weather("41.390205", "2.154007")
        .then(result => {expect(result.currently.xxx).toBeUndefined()
        })
    })
    it('should succes temperature', () => {

      return logic.weather("41.390205", "2.154007")
        .then(result => {expect(result.currently.temperature).toBeDefined()
        })
    })
    ...
    it('should succes field', () => {
      ...
      return logic.weather("41.390205", "2.154007")
        .then(result => {expect(result.currently.icon).toBeDefined()
        })
    })

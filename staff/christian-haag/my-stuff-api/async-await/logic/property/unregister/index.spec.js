...
describe('logic - unregister properties', () => {
    ...
    beforeEach(async () => {
        ...
        ownerId1 = owner.id
        propId1 = property.id
        await logic.registerOwnerProperty(propId1, ownerId1)
    ...
    it('schould delete properties by ownerId', async () => {
        const property = await logic.unregisterProperty(propId1, ownerId1)

...
WelcomePanel.prototype.onClickSearchProducts = function (expression) {
    var searchButton = this.container.children[2]

    searchButton.addEventListener('submit', function (event) {
        event.preventDefault();
        var query = event.target.qry.value;
        expression(query)
    })
}

WelcomePanel.prototype.refreshProducts = function (expression) {
    var refreshButton = this.container.children[2].children[2].children[1]
...
WelcomePanel.prototype.onClickLogout = function (expression) {
    var logoutButton = this.container.children[3].children[0]
...
ProductPanel.prototype.hideOnLogOut = function (expression) {
    var logoutButton = panels[4].children[3].children[0];

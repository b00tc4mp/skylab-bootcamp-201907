...
describe('logic', () => {
    ...
    describe('retrieve duck', () => {
        ...
        it('should fail on undefined expression', () => {
            expect(() => logic.retrieveDuck('something')).toThrowError(TypeError, `undefined is not a function`)
        })
    ...
    describe('add duck to favorites', () => {
        ...
        beforeEach(() => {
            ...
            users.push({ name, surname, email, password, favorites: new Curray })
        })
...
//remove ducks
    ...
    describe('remove duck from favorites', () => {
            ...
            beforeEach(() => {
                ...
                users.push({ name, surname, email, password, favorites: new Curray('5c3853aebd1bde8520e66ee8', '5c3853aebd1bde8520e66ec4') })
            })
            it('should succeed on remove fav ducks ',() => {
                const id = '5c3853aebd1bde8520e66ee8'

                logic.removeDuckFromFavorites(email, id, error =>{
                    expect(error).toBeUndefined()
...
//retrieve favorite ducks
    describe('retrieve favorite ducks', () => {
        ...
        it('should fail on undefined expression', () => {
            expect(() => logic.retrieveFavoriteDucks('something')).toThrowError(TypeError, `undefined is not a function`)
        })

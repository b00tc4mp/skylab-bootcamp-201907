...
home.results.onClickItem = function(id) {
    logic.retrieveDuck(id, function(duck) {
        home.results.hide();
        home.detail.displayDuck(duck, logic.addDuckToFavourites);
        logic.addDuckToFavourites.color();
        home.detail.show();
    });
};
...
var favourite = new Favourite(document.getElementsByClassName('duck-myfavourite')[0]);



home.onClickShowFavourites(function () {
    debugger
    //home.hide(); 
    favourite.show();
    //landing.show();
    //favourite.listItems(logic.getFavouritesList());
    home.results.listItems(logic.getFavouritesList());
});
...
//var favourite = new Favourite (document.getElementsByClassName('duck-favourite')[0])
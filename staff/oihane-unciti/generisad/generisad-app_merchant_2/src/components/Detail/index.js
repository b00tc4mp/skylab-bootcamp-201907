        ...
        {ad && <>
             ...
             <div className= "detail__mosaic">
                    <div className= "detail__fav" >
                        <button className = "heart" onClick ={() => history.go(-1)}><FontAwesomeIcon icon={faArrowLeft} size="2x" color="white"/> </button>
                        
                        {favorites ?
                            <button className = "heart" onClick={() => handleFav(ad._id)}><FontAwesomeIcon icon={faCar} size="3x" color="#ec2c2c"
                            transform="left-1 rotate-15"/></button>
                            :
                            <button className = "heart" onClick={() => handleFav(ad._id)}><FontAwesomeIcon icon={faCar} size="3x" color="white"/></button>
                            }
                    </div>

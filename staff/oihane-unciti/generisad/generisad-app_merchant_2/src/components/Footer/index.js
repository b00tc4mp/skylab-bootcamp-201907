...
function Footer (){
    ...
    <footer class="footer">
        ...
        <li class="footer__list">
            <p className= "footer__title">Contacta con nosotros en <strong>milcoches@coches.com</strong><br/>O a través de nuestras redes sociales </p>
            ...
            <a href="https://www.twitter.com"><img className="icons_social_media" width="50"  src={require('../../img/iconfinder_Twitter.png')}alt="Twitter.png"></img></a>

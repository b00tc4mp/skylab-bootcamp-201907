...
Animal.prototype.newInstance = function() {
...
Human.prototype.newInstance = function() {
	return new Human(undefined, 0, Math.random() > 0.5? 'female' : 'male');
};

var paul = new Human('vegan', 25, 'male');
var megan = new Human('omnivore', 23, 'female');
...
Woman.prototype.newInstance = function() {
...
Man.prototype.newInstance = function() {
	return Math.random() > 0.5? new Woman(undefined, 0) : new Man(undefined, 0);
};
...
mary.newInstance = function() { return { brand: 'Alien' }; };
